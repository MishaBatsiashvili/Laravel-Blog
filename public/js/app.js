...
__webpack_require__(/*! ./category/category-dropdown */ "./resources/js/category/category-dropdown.js"); // let ClassicEditor = require( '@ckeditor/ckeditor5-build-classic' );
...
/***/ "./resources/js/category/category-dropdown.js":
/*!****************************************************!*\
  !*** ./resources/js/category/category-dropdown.js ***!
  \****************************************************/
/***/ (() => {
...
window.addEventListener('load', function () {
  var category = document.querySelector('#category_filter');
  if (!category) return;
  category.addEventListener('change', function (e) {
    ...
    window.location.replace("/?category=".concat(selectedSlug));
  });
});
